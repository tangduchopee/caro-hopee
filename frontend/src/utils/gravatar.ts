/**
 * Gravatar utilities for avatar generation
 */

/**
 * Simple MD5 hash implementation for Gravatar
 * Based on SparkMD5 algorithm (https://github.com/nickmocz/spark-md5)
 */
...
/**
 * Get the MD5 hash of an email for Gravatar
 */
...
export const getGravatarUrl = (
  email: string,
  size: number = 200,
  defaultImage: 'mp' | '404' | 'identicon' | 'retro' = 'mp'
): string => {
...
/**
 * Check if user has a Gravatar avatar
 * @param email - User email
 * @returns Promise<boolean> - true if user has Gravatar
 */
